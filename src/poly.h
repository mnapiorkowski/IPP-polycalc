 ...
 * @return Czy wielomian jest wspĂłĹ‚czynnikiem?
 */
...
/**
 * Wypisuje wielomian w postaci nawiasowo-plusowej.
 * @param[in] p : wielomian
 */
 ...
 * oraz zwalnia pamięć przeznaczoną na tę tablicę.
...
/**
 * Zmienia wielomian "tablicowy" tożsamościowo równy współczynnikowi
 * w postać "współczynnikową".
 * Zwalnia pamięć, jaką wielomian zajmował‚ w postaci "tablicowej".
 * @param[in] p : wielomian
 */
void PolyToCoeff(Poly *p);

/**
 * Zmienia wielomian "współczynnikowy" w "tablicowy",
 * tożsamościowo równy współczynnikowi.
 * @param[in] p : wielomian "współczynnikowy"
 * @param[in,out] pp : wielomian "tabllicowy"
 */
 ...
 * @param[in] p : wielomian @f$p@f$
 * @param[in] x : wartoĹ›Ä‡ argumentu @f$x@f$
 ...
 * @param[in] p : wielomian @f$p@f$
 * @param[in] exp : wykładnik potęgi, do której mamy podnieść wielomian
 * @return @f$p^{exp}@f$
 */
Poly PolyPower(const Poly *p, poly_exp_t exp);

/**
 * Składa dwa wielomiany.
 * @param[in] p : wielomian @f$p@f$
 * @param[in] k : liczba wielomianów do podstawienia
 * @param[in] q : tablica wielomianów do podstawienia pod @f$k@f$ kolejnych
